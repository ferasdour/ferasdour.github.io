...
A.length||document.addEventListener("DOMContentLoaded",(function(){for(var e=0,t=A;e<t.length;e++)(0,t[e])()})),A.push(t)):t()},C=function(e,t,n){return void 0===t&&(t=[]),void 0===n&&(n=e),"function"==typeof e?e.call.apply(e,t):n},O=function(e,t,n){if(void 0===n&&(n=!0),n){var i=function(e){if(!e)return 0;
...
/**
   ...
   * Licensed under MIT (https://github.com/twbs/bootstrap/blob/main/LICENSE)
   * --------------------------------------------------------------------------
   */function Q(e){if("true"===e)return!0;if("false"===e)return!1;if(e===Number(e).toString())return Number(e);if(""===e||"null"===e)return null;if("string"!=typeof e)return e;try{return JSON.parse(decodeURIComponent(e))}catch(t){return e}}function U(e){return e.replace(/[A-Z]/g,(function(e){return"-"+e.toLowerCase()}))}var X=function(e,t,n){e.setAttribute("data-bs-"+U(t),n)},Y=function(e,t){e.removeAttribute("data-bs-"+U(t))},$=function(e){if(!e)return{};for(var t,n={},i=Object.keys(e.dataset).filter((function(e){return e.startsWith("bs")&&!e.startsWith("bsConfig")})),r=a(i);!(t=r()).done;){var o=t.value,s=o.replace(/^bs/,"");n[s=s.charAt(0).toLowerCase()+s.slice(1)]=Q(e.dataset[o])}return n},G=function(e,t){return Q(e.getAttribute("data-bs-"+U(t)))},J=function(){function e(){}var i=e.prototype;return i._getConfig=function(e){return e=this._mergeConfigObj(e),e=this._configAfterMerge(e),this._typeCheckConfig(e),e},i._configAfterMerge=function(e){return e},i._mergeConfigObj=function(e,t){var i=m(t)?G(t,"config"):{};// try to parse
...
// Static
,n.getInstance=function(e){return u(g(e),this.DATA_KEY)},n.getOrCreateInstance=function(e,t){return void 0===t&&(t={}),this.getInstance(e)||new this(e,"object"==typeof t?t:null)},n.eventName=function(e){return""+e+this.EVENT_KEY},t(n,null,[{key:"VERSION",get:function(){return"5.3.5"}},{key:"DATA_KEY",get:function(){return"bs."+this.NAME}},{key:"EVENT_KEY",get:function(){return"."+this.DATA_KEY}}]),n}(J),ee=function(e){var t=e.getAttribute("data-bs-target");if(!t||"#"===t){var n=e.getAttribute("href");
...
throw new TypeError(Nn.toUpperCase()+': Option "reference" provided type "object" without a required "getBoundingClientRect" method.');return t},o._createPopper=function(){if(void 0===Pn)throw new TypeError("Bootstrap's dropdowns require Popper (https://popper.js.org/docs/v2/)");var e=this._element;"parent"===this._config.reference?e=this._parent:m(this._config.reference)?e=g(this._config.reference):"object"==typeof this._config.reference&&(e=this._config.reference);var t=this._getPopperConfig();this._popper=Dn(e,this._menu,t)},o._isShown=function(){return this._menu.classList.contains(Qn)},o._getPlacement=function(){var e=this._parent;if(e.classList.contains("dropend"))return ei;if(e.classList.contains("dropstart"))return ti;if(e.classList.contains("dropup-center"))return"top";if(e.classList.contains("dropdown-center"))return"bottom";
...
e.modifiers=[{name:"applyStyles",enabled:!1}]),n({},e,C(this._config.popperConfig,[void 0,e]))},o._selectMenuItem=function(e){var t=e.key,n=e.target,i=te.find(".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)",this._menu).filter((function(e){return v(e)}));i.length&&
